namespace Agenda_de_Obras
{
    ...
    public partial class Data_INSERIDAS
    {
        [Key]
        [Column(Order = 0)]
        ...
        [Key]
        [Column("QUEM INSERIU", Order = 4)]
        public string QUEM_INSERIU { get; set; }

        [Key]
        [Column("DATA INSERÇÃO", Order = 5)]
        public DateTime DATA_INSERÇÃO { get; set; }
    }
}
